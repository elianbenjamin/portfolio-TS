...
const Menu = () => {
  return (
    <div className="fixed bottom-0 sm:bottom-12 w-full sm:w-fit left-1/2 -translate-x-1/2 bg-accent rounded-t-xl sm:rounded-full py-3 px-6 items-center justify-around sm:justify-center gap-12 z-30 sm:mx-auto">
